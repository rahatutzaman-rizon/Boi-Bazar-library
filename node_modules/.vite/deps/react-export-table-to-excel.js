...
// node_modules/react-export-table-to-excel/lib/utils/create-table.js
var require_create_table = __commonJS({
  "node_modules/react-export-table-to-excel/lib/utils/create-table.js"(exports) {
    "use strict";
    ...
    function createTable({ header, body }) {
      ...
      const bodies = body.map((val, i) => {
        if (Array.isArray(val)) {
          return react_1.default.createElement("tr", { key: i }, val.map((value, i2) => react_1.default.createElement(
            "th",
            { key: i2 },
            " ",
            value,
        ...
        if (val !== null && typeof val === "object") {
          return react_1.default.createElement("tr", { key: i }, Object.entries(val).map(([key, value], i2) => {
            if (typeof value === "object") {
              console.error(`typeof ${key} is incorrect, only accept ${acceptTypes.join(", ")} `);
              return react_1.default.createElement("th", { key: i2 });
            }
      ...
      return (0, server_1.renderToString)(react_1.default.createElement(
        "table",
        null,
...
// node_modules/react-export-table-to-excel/lib/utils/index.js
var require_utils = __commonJS({
  "node_modules/react-export-table-to-excel/lib/utils/index.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var create_table_1 = require_create_table();
    Object.defineProperty(exports, "createTable", { enumerable: true, get: function() {
      return __importDefault(create_table_1).default;
    } });
  }
});

// node_modules/react-export-table-to-excel/lib/lib.js
var require_lib = __commonJS({
  "node_modules/react-export-table-to-excel/lib/lib.js"(exports) {
    "use strict";
    ...
    function valEnv() {
      if (!document) {
        if ((process === null || process === void 0 ? void 0 : "development") !== "production") {
    ...
    function download(fileName, context) {
      ...
      element.href = utils.uri + utils.base64(utils.format(utils.template, context));
...
// node_modules/react-export-table-to-excel/lib/hooks/useExcel.js
var require_useExcel = __commonJS({
  "node_modules/react-export-table-to-excel/lib/hooks/useExcel.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/react-export-table-to-excel/lib/index.js
var require_lib2 = __commonJS({
  "node_modules/react-export-table-to-excel/lib/index.js"(exports) {
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.downloadExcel = exports.useDownloadExcel = exports.DownloadTableExcel = void 0;
    var react_1 = __importDefault(require_react());
    var useExcel_1 = require_useExcel();
    Object.defineProperty(exports, "useDownloadExcel", { enumerable: true, get: function() {
      return useExcel_1.useDownloadExcel;
    } });
    var lib_1 = require_lib();
    Object.defineProperty(exports, "downloadExcel", { enumerable: true, get: function() {
      return lib_1.downloadExcel;
    } });
    var DownloadTableExcel = ({ currentTableRef, filename, sheet, children }) => {
      const { onDownload } = (0, useExcel_1.useDownloadExcel)({ currentTableRef, filename, sheet });
      return react_1.default.createElement("span", { onClick: onDownload }, children);
    };
    exports.DownloadTableExcel = DownloadTableExcel;
  }
});
...
react-dom/cjs/react-dom-server.browser.development.js:
   ...
   *)
*/
//# sourceMappingURL=react-export-table-to-excel.js.map
