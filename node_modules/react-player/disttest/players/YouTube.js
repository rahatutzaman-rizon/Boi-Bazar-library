...
var YouTube = class extends import_react2.Component {
...
var TEST_URL = "https://www.youtube.com/watch?v=oUFJJNQGwhk";
var TEST_CONFIG = {
  playerVars: {},
  embedOptions: {}
};
...
test2("load()", (t) => {
  ...
  return new Promise((resolve) => {
    ...
    const instance = (0, import_react_test_renderer2.create)(
      /* @__PURE__ */ import_react3.default.createElement(YouTube, { url: TEST_URL, config: TEST_CONFIG, onReady })
    ).getInstance();
...
test2("load() when ready", (t) => {
  const getSDK3 = sinon2.stub(getSDK, "stub").resolves();
  const instance = (0, import_react_test_renderer2.create)(
    /* @__PURE__ */ import_react3.default.createElement(YouTube, { url: TEST_URL, config: TEST_CONFIG })
  ).getInstance();
  instance.player = { cueVideoById: sinon2.fake() };
  ...
  t.ok(getSDK3.notCalled);
  getSDK3.restore();
});
test2("onStateChange() - play", (t) => {
  const called = {};
  const onPlay = () => {
    called.onPlay = true;
  };
  const onBufferEnd = () => {
    called.onBufferEnd = true;
  };
  const instance = (0, import_react_test_renderer2.create)(/* @__PURE__ */ import_react3.default.createElement(YouTube, { url: TEST_URL, onPlay, onBufferEnd, config: {} })).getInstance();
  instance.onStateChange({ data: "PLAYING" });
  t.ok(called.onPlay && called.onBufferEnd);
});
test2("onStateChange() - pause", async (t) => {
  const onPause = () => t.ok(true);
  const instance = (0, import_react_test_renderer2.create)(/* @__PURE__ */ import_react3.default.createElement(YouTube, { url: TEST_URL, onPause, config: {} })).getInstance();
  instance.onStateChange({ data: "PAUSED" });
});
test2("onStateChange() - buffer", async (t) => {
  const onBuffer = () => t.ok(true);
  const instance = (0, import_react_test_renderer2.create)(/* @__PURE__ */ import_react3.default.createElement(YouTube, { url: TEST_URL, onBuffer, config: {} })).getInstance();
  instance.onStateChange({ data: "BUFFERING" });
});
test2("onStateChange() - ended", async (t) => {
  const onEnded = () => t.ok(true);
  const instance = (0, import_react_test_renderer2.create)(/* @__PURE__ */ import_react3.default.createElement(YouTube, { url: TEST_URL, onEnded, config: {} })).getInstance();
  instance.player = { getPlaylist: () => {
  } };
  instance.onStateChange({ data: "ENDED" });
});
test2("onStateChange() - ready", async (t) => {
  const onReady = () => t.ok(true);
  const instance = (0, import_react_test_renderer2.create)(/* @__PURE__ */ import_react3.default.createElement(YouTube, { url: TEST_URL, onReady, config: {} })).getInstance();
  instance.onStateChange({ data: "CUED" });
});
test2("render()", (t) => {
  const style = { width: "100%", height: "100%", display: void 0 };
  t.deepEqual(
    (0, import_react_test_renderer2.create)(/* @__PURE__ */ import_react3.default.createElement(YouTube, { url: TEST_URL })).toJSON(),
