...
var FilePlayer = class extends import_react2.Component {
  ...
  render() {
    const { url, playing, loop, controls, muted, config: config2, width, height } = this.props;
    ...
    return /* @__PURE__ */ import_react2.default.createElement(
      ...
      config2.tracks.map(this.renderTrack)
    );
  }
};

// test/players/FilePlayer.js
test2.skip = (name) => console.log(`Skipped ${name}`);
var config = defaultProps.config.file;
var setProps = (wrapper, props) => {
  const current = wrapper.toTree();
  wrapper.update(import_react3.default.createElement(current.type, {
    ...current.props,
    ...props
  }));
};
var render = (comp) => {
  return (0, import_react_test_renderer2.create)(comp, {
    createNodeMock: () => ({
...
test2("listeners", (t) => {
  const addListeners = sinon2.spy(FilePlayer.prototype, "addListeners");
  const removeListeners = sinon2.spy(FilePlayer.prototype, "removeListeners");
  const wrapper = render(
    /* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp4", config, playsinline: true })
  );
...
test2("onSeek", (t) => {
  const onSeek = sinon2.fake();
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp4", config, onSeek })).getInstance();
  instance.onSeek({ target: { currentTime: 10 } });
  t.ok(onSeek.calledOnceWith(10));
});
test2("load - hls", async (t) => {
  class Hls {
  ...
  const url = "file.m3u8";
  const getSDK3 = sinon2.stub(getSDK, "stub").resolves(Hls);
  const onLoaded = () => t.ok(true);
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config, onLoaded })).getInstance();
  instance.load(url);
...
test2("onError - hls", (t) => {
  return new Promise((resolve) => {
    ...
    const instance = render(
      /* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config, onLoaded, onError })
    ).getInstance();
    instance.load(url);
    getSDK3.restore();
  });
...
test2("onError - flv", (t) => {
  return new Promise((resolve) => {
    ...
    const url = "file.flv";
    const getSDK3 = sinon2.stub(getSDK, "stub").resolves(flvjs);
    const onLoaded = () => null;
    const instance = render(
      /* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config, onLoaded, onError })
    ).getInstance();
...
test2("load - dash", async (t) => {
  ...
  const url = "file.mpd";
  const getSDK3 = sinon2.stub(getSDK, "stub").resolves(dashjs);
  const onLoaded = () => t.ok(true);
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config, onLoaded })).getInstance();
  instance.load(url);
  t.ok(getSDK3.calledOnce);
...
test2("load - MediaStream", (t) => {
  const url = new globalThis.MediaStream();
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config })).getInstance();
  instance.load(url);
  t.ok(instance.player.srcObject === url);
  t.falsy(instance.player.src);
});
test2("load - MediaStream (srcObject not supported)", (t) => {
  const url = new globalThis.MediaStream();
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config })).getInstance();
...
test2("load - Blob URI", (t) => {
  const url = 'blob:http://example.com:ceeed153-91f1-4456-a4a7-cb4085810cc4"';
  const wrapper = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config }));
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: url }, false, [])
  ));
});
test2("forceVideo", (t) => {
  const wrapper = render(
  ...
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: "file.mp3" }, false, [])
  ));
});
test2("forceAudio", (t) => {
  const wrapper = render(
  ...
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("audio", { src: "file.mp4" }, false, [])
  ));
});
test2("render video poster", (t) => {
  const wrapper = render(
    /* @__PURE__ */ import_react3.default.createElement(
      FilePlayer,
      {
  ...
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: "file.mp3", poster: "poster.png" }, false, [])
  ));
});
test2("play()", (t) => {
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp4", config })).getInstance();
  instance.player.play = sinon2.fake();
  instance.play();
  t.ok(instance.player.play.calledOnce);
});
test2("play() - promise", (t) => {
  const onError = () => t.ok(true);
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp4", config, onError })).getInstance();
  instance.player.play = sinon2.fake.returns({ catch: (cb) => cb() });
  instance.play();
  t.ok(instance.player.play.calledOnce);
});
test2("pause()", (t) => {
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp4", config })).getInstance();
  instance.player.pause = sinon2.fake();
  instance.pause();
  t.ok(instance.player.pause.calledOnce);
});
test2("stop()", (t) => {
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp4", config })).getInstance();
  instance.player.removeAttribute = sinon2.fake();
  instance.stop();
  t.ok(instance.player.removeAttribute.calledOnceWith("src"));
});
test2("stop() - dash", (t) => {
  const instance = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mpd", config })).getInstance();
  instance.dash = { reset: sinon2.fake() };
  instance.stop();
...
test2("render - video", (t) => {
  const wrapper = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp4", config }));
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: "file.mp4" }, false, [])
  ));
});
test2("render - audio", (t) => {
  const wrapper = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp3", config }));
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("audio", { src: "file.mp3" }, false, [])
  ));
});
test2("render - hls", (t) => {
  const wrapper = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.m3u8", config }));
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: void 0 }, false, [])
  ));
});
test2("render - dash", (t) => {
  const wrapper = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mpd", config }));
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: void 0 }, false, [])
  ));
});
test2("render - dropbox", (t) => {
  const url = "https://www.dropbox.com/s/abc/file.mp4";
  const wrapper = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config }));
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: "https://dl.dropboxusercontent.com/s/abc/file.mp4" }, false, [])
  ));
});
test2("render - string array", (t) => {
  const url = ["file.mp4", "file.ogg"];
  const wrapper = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config }));
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: void 0 }, [
      /* @__PURE__ */ import_react3.default.createElement("source", { key: 0, src: "file.mp4" }),
      /* @__PURE__ */ import_react3.default.createElement("source", { key: 1, src: "file.ogg" })
    ], [])
  ));
});
test2("render - object array", (t) => {
  const url = [
  ...
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: void 0 }, [
      /* @__PURE__ */ import_react3.default.createElement("source", { key: 0, src: "file.mp4", type: "video/mp4", media: "(max-width:800px)" }),
      /* @__PURE__ */ import_react3.default.createElement("source", { key: 1, src: "file.mp4", type: "video/mp4" }),
      /* @__PURE__ */ import_react3.default.createElement("source", { key: 1, src: "file.ogg", type: "video/ogg" })
    ], [])
  ));
});
test2.skip("render tracks", (t) => {
  const wrapper = render(
    /* @__PURE__ */ import_react3.default.createElement(
      FilePlayer,
      {
  ...
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: "file.mp4" }, false, [
      /* @__PURE__ */ import_react3.default.createElement("track", { key: 0, kind: "subtitles", src: "subtitles.en.vtt", srcLang: "en", default: true }),
      /* @__PURE__ */ import_react3.default.createElement("track", { key: 1, kind: "subtitles", src: "subtitles.js.vtt", srcLang: "js" })
    ])
  ));
});
test2("auto width/height", (t) => {
  const wrapper = render(
    /* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url: "file.mp4", config, width: "auto", height: "auto" })
  );
  t.ok(containsMatchingElement(
    wrapper,
    /* @__PURE__ */ import_react3.default.createElement("video", { src: "file.mp4", style: { width: "auto", height: "auto" } }, false, [])
  ));
});
test2("clear srcObject on url change", (t) => {
  const url = new globalThis.MediaStream();
  const wrapper = render(/* @__PURE__ */ import_react3.default.createElement(FilePlayer, { url, config }));
