...
var Streamable = class extends import_react2.Component {
...
// test/players/Streamable.js
var TEST_URL = "https://streamable.com/moo";
var TEST_CONFIG = {
  options: {}
};
...
test2("load()", (t) => {
  ...
  return new Promise((resolve) => {
    ...
    const instance = (0, import_react_test_renderer2.create)(
      /* @__PURE__ */ import_react3.default.createElement(Streamable, { url: TEST_URL, onReady, config: TEST_CONFIG })
    ).getInstance();
...
test2("getDuration()", (t) => {
  const instance = (0, import_react_test_renderer2.create)(/* @__PURE__ */ import_react3.default.createElement(Streamable, { url: TEST_URL })).getInstance();
...
test2("render()", (t) => {
  ...
  t.deepEqual(
    (0, import_react_test_renderer2.create)(/* @__PURE__ */ import_react3.default.createElement(Streamable, { url: TEST_URL })).toJSON(),
